    ...
    questions: [
      {
        ...
        options: ["Chiziqli bo'lmagan", "Chiziqli", "Graf", "Daraxt"],
        correctAnswer: 1,
      },
      {
        question: "Stack (Stek) qanday ishlaydi?",
        options: ["Priority", "Random", "LIFO", "FIFO"],
        correctAnswer: 2,
      },
      {
        question: "Queue (Navbat) qanday ishlaydi?",
        options: ["Random", "FIFO", "Priority", "LIFO"],
        correctAnswer: 1,
      },
      {
        question:
          "Linked List (Bog'langan ro'yxat) qanday ma'lumotlar strukturasi?",
        options: ["Daraxt", "Graf", "Chiziqli bo'lmagan", "Chiziqli"],
        correctAnswer: 3,
      },
      {
        question:
          "Binary Tree (Ikkilik daraxt) qanday ma'lumotlar strukturasi?",
        options: ["Graf", "Chiziqli", "Daraxt", "Chiziqli bo'lmagan"],
        correctAnswer: 2,
      },
      {
      ...
      },
      {
        ...
        options: ["Graf", "Massiv", "Daraxt", "Chiziqli"],
        correctAnswer: 2,
      },
      {
  ...
  Kombinatorika: {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Daraja", "Faktorial", "Ko‘paytma", "Natija"],
        correctAnswer: 1,
      },
      {
      ...
      },
      {
        ...
        options: ["Permutatsiya", "Daraja", "Kombinatsiya", "Ko‘paytma"],
        correctAnswer: 2,
      },
      {
      ...
      },
      {
        ...
        options: ["720", "362880", "120", "5040"],
        correctAnswer: 3,
      },
      {
        question: "Binom koeffitsiyenti degani nima?",
        options: ["n!", "n^k", "k!", "C(n, k)"],
        correctAnswer: 3,
      },
      {
      ...
      },
      {
        ...
        options: ["Yo‘q", "Ba'zida", "Ha", "Hech qachon"],
        correctAnswer: 2,
      },
      {
        question:
          "n ta elementdan o‘z-o‘zini takrorlamasdan k ta tanlov – bu nima?",
        options: ["Permutatsiya", "To‘plam", "Daraja", "Kombinatsiya"],
        correctAnswer: 3,
      },
    ],
  },
